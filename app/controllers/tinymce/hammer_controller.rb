class Tinymce::HammerController < ActionController::Base
  ...
  # Generates lists for the tinyMce images and meias controls options
  def lists
    Tinymce::Hammer.custom_config_setup
    params[:type] ||= 'images'
    case params[:type]
    when 'images'
    ...
    when 'media'
      ...
      dir         = Tinymce::Hammer.media_list_path
    when 'links'
      res         = "var tinyMCELinkList = new Array( "
